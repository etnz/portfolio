...
// TestImportExportMarketData creates a very basic check that imports is working as expected.
func TestImportExportMarketData(t *testing.T) {
	sample1 := `
...
`
	...
	sb := strings.Builder{}
	if err := ExportMarketData(&sb, market); err != nil {

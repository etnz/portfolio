...
// TestLoadAndSaveCycle verifies that loading an unsorted JSONL file and immediately
// saving it results in a correctly and stably sorted file.
func TestLoadAndSaveCycle(t *testing.T) {
...
`
	...
	err = Save(&savedBuffer, transactions)
	if err != nil {
